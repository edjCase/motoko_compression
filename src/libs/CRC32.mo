...
module CRC32 {
    ...
    public class CRC32() {
        ...
        let PAYLOAD_SIZE = 8;
        let INIT_SIZE = 16;
        var payload = Array.init<Nat8>(INIT_SIZE, 0);
        var payload_count = 0;
        ...
        public func updateByte(byte : Nat8) {
            ...
            if (input_size >= INIT_SIZE and payload_count >= PAYLOAD_SIZE) {
                ...
                if (payload_count > 0) {
                    ...
                    for (i in Iter.range(0, payload_count - 1)) {
        ...
        public func updateIter(iter : Iter.Iter<Nat8>) {
            for (byte in iter) {
                updateByte(byte);
            };
        };
        ...
        func singleSlicingUpdate(crc : Nat32) : Nat32 {
            ...
            u := u ^ (
                nat8ToNat32(p[0]) | nat8ToNat32(p[1]) << 8 | nat8ToNat32(p[2]) << 16 | nat8ToNat32(p[3]) << 24
            );
        ...
        func simpleUpdate(crc : Nat32) : Nat32 {
